                ...
                <v-container>
                    ...
                    <div class="">
                        ...
                        <div class="flex justify-between">
                            <nested-draggable v-model="listData" class="w-full"></nested-draggable>
                            </div>
...
import NestedDraggable from '@/Components/NestedDirective.vue';
...
console.log(props.data , props.Items);
...
const EditPage = async () => {
    ...
    try {
        const response = await axios.put(
            route("menu_manager.update", { menu: props.data.id }),
            filteredPayload
        );
        toast.success(response.data.message);
    } catch (error) {
