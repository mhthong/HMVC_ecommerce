                        ...
                        <v-row>
                            <v-col cols="12" md="9">
                                ...
                                >
                                    ...
                                    :label="field.name"
                                    :items="field.items"
                                    v-if="field.type === 'select' && field.key === 'slider'"
                                    :rules="
                            ...
                            <v-col cols="12" md="3">
                                ...
                                <div class="border border-secondary p-3 mb-2">
                                    <ul class="ul-category">
                                        ...
                                        >
                                            <v-checkbox
                                                v-model="Form.fields.page.value"
                                                :value="page.id"
                                                :label="page.name"
                                            ></v-checkbox>
                                        </li>
...
const CreatePost = async () => {
    ...
    // Bước 1: Tạo payload từ các fields
    const payload = Object.entries(fields).reduce((acc, [key, field]) => {

        acc[key] = field.includes === "image" ? document.getElementById(field.key)?.value || "": field.value;
