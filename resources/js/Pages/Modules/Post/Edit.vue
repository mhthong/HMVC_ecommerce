                    ...
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="12" md="3">
                                ...
                                <div
                                    v-if="
                                        Form.fields.image.includes === 'image'
                                    "
                                    ...
                                    <v-row>
                                        <v-col cols="6">
                                            <div
                                                ...
                                                :id="
                                                    'holder' +
                                                    Form.fields.image.key
                                                "
                                            >
                                                <img
                                                    :src="
                                                        Form.fields.image.value
                                                    "
                                                    alt=""
                                                    style="height: 80px"
                                                />
...
const EditPost = async () => {
    ...
    try {
        const response = await axios.put(
            route("post_manager.update", { post: props.data.id }),
            filteredPayload
        );
